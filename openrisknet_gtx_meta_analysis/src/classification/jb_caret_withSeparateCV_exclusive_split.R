###
# This script is almost identical to jb_caret_withSeparateCV.R, except it ensures that 
# all samples of a compound can only be in either training data or test data. In script jb_caret_withSeparateCV.R 
...
# So, in script we used to get very high accuracies due to the misleading random splits of a data in script jb_caret_withSeparateCV.R
