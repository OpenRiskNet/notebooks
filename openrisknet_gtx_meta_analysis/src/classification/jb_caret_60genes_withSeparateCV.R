...
if(length(args)!=3){
  print(args)
  print("Please specify locations of: work_dir and all_training_and_test_in_single_file and selected_genes_file with --args option of R");
...
all_data = all_data1[,c(1,which(cols %in% as.character(selected_genes[,1])))];
print(dim(all_data))
